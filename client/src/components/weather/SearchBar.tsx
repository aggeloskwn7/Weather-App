    ...
    <div className="relative flex-1 max-w-md mx-4">
      <div className="relative">
        <input 
          ...
          ref={searchInputRef}
          className="w-full py-2 pl-10 pr-10 rounded-lg border border-input bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent shadow-sm"
          value={searchQuery}
        ...
        >
          <LocateIcon className="h-4 w-4 text-weather-accent hover:text-weather-accent/80 transition-colors" />
        </button>
      </div>
      ...
      {showResults && (
        ...
        >
          ...
          {locationResults?.map((location, index) => (
            ...
            >
              <MapPin className="h-4 w-4 text-weather-accent mr-3 flex-shrink-0" />
              <span>
                {location.name}
